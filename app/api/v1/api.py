...
try:
    ...
    # Temporarily comment out strategy_monetization to debug
    # from .endpoints import strategy_monetization
...
# Temporarily comment out strategy_monetization router to debug
